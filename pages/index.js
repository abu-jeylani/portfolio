          ...
          <div className="pt-10 leading-8 text-gray-800 dark:text-gray-200 max-w-xl mx-auto text-center">
            <div className="mb-10">
              <h1 className="mb-1 font-mono text-4xl text-black-100">
                <span className="inline-flex h-20 pt-2 dark:text-whit overflow-x-hidden animate-type group-hover:animate-type-reverse whitespace-nowrap text-brand-accent will-change-transform">
                  hi, I&apos;m Abu
                </span>
